 ...
 */
public class PageWidgetProjections {

  @Projection(name = "default", types = {PageWidget.class})
  ...
  /**
   * PageWidget 상세, 기본 항목 외 Configuration 항목 추가
   */
  @Projection(name = "forDetailView", types = {PageWidget.class})
