...
@JsonSubTypes({
    @JsonSubTypes.Type(value = PageWidgetConfiguration.class, name = "page"),
    @JsonSubTypes.Type(value = TextWidgetConfiguration.class, name = "text"),
    @JsonSubTypes.Type(value = FilterWidgetConfiguration.class, name = "filter")
})
public abstract class WidgetConfiguration implements Serializable {
