...
package app.metatron.discovery.domain.datasource.connection.jdbc.query.expression;
...
public class NativeProjection {
  ...
  private class ProjectionBean {
     ...
     * @return the string
     */
    public String toSQL(DataConnection.Implementor implementor) {
   ...
   * @return the string
   */
  public String projectionToSQL(DataConnection.Implementor implementor) {
   ...
   * @return the string
   */
  public String groupByToSQL(DataConnection.Implementor implementor) {
  ...
  public List<String> getAliases(DataConnection.Implementor implementor){
  ...
  public static String getQuotedColumnName(DataConnection.Implementor implementor, String columnName){
    switch (implementor){
