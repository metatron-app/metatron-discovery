 ...
 */
public class TextWidgetProjections {

  @Projection(name = "default", types = {TextWidget.class})
  ...
  /**
   * FilterWidget 상세, 기본 항목 외 Contents, Configuration 항목 추가
   */
  @Projection(name = "forDetailView", types = {TextWidget.class})
