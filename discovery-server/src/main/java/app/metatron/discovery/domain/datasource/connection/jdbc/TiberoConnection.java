...
@JsonTypeName("TIBERO")
public class TiberoConnection extends JdbcDataConnection {
...
//    return "SELECT tname FROM tab WHERE tabtype='TABLE'";
  ...
  public String getTableDescQuery(String schema, String table) {
    ...
    StringBuilder builder = new StringBuilder();
    builder.append(" SELECT t.*, o.owner ");
    builder.append( "FROM all_objects o, user_tables t   ");
    builder.append("WHERE 1=1");
//    builder.append("AND o.owner LIKE '" + schema + "' " + " ");
    builder.append("AND o.object_name LIKE '" + table + "' " + " ");
    builder.append("AND o.object_name  = t.table_name ");
    return builder.toString();
  }
...
//
//    StringBuilder builder = new StringBuilder();
//    builder.append(TIBERO_URL_PREFIX);
//
//    // Set HostName
