...
public interface NotebookAction {
  ...
  String createNotebook(Notebook notebook);

  void deleteNotebook(String notebookId);

  String runAllJobs(Notebook notebook);

  String nbconvertScript(Notebook notebook);

//  String publishModel(NotebookModel model);

  void createDirectory(String workspaceId);
