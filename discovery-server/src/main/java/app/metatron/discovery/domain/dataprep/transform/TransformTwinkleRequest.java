 ...
 */
public class TransformTwinkleRequest implements Serializable {
    List<String> rules;

    boolean stackStages;

    String dsId;    // for job group name (for job cancel)
    ...
    public TransformTwinkleRequest() {
        this.stackStages = true;
    }

    public TransformTwinkleRequest(List<String> rules, PrepDataset prepdataset) {
        this.rules = rules;
        this.stackStages = true;
