...
@JsonSubTypes({
    @JsonSubTypes.Type(value = GenericSort.class, name = "generic"),
    @JsonSubTypes.Type(value = Lexicographic.class, name = "lexicographic"),
    @JsonSubTypes.Type(value = Strlen.class, name = "strlen")
})
