...
public class OracleConnectionTest {
  ...
  @Test
  public void searchOracleSchemas() {
  ...
  @Test
  public void searchOracleTables() {
    OracleConnection connection = new OracleConnection();
    connection.setHostname("ora11.cof5lvzznx9y.ap-northeast-2.rds.amazonaws.com");
    connection.setPort(1521);
    connection.setSid("ora11");
  ...
  @Test
  public void showTableInfoOracle() {
    OracleConnection connection = new OracleConnection();
    connection.setHostname("ora11.cof5lvzznx9y.ap-northeast-2.rds.amazonaws.com");
    connection.setPort(1521);
    connection.setSid("ora11");
  ...
  @Test
  public void showTableColumnOracle() {
    OracleConnection connection = new OracleConnection();
    connection.setHostname("ora11.cof5lvzznx9y.ap-northeast-2.rds.amazonaws.com");
    connection.setPort(1521);
    connection.setSid("ora11");
