...
public class PrepDatasetRestIntegrationTest extends AbstractRestIntegrationTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(PrepDatasetRestIntegrationTest.class);
