...
public class DataQueryRestIntegrationTest extends AbstractRestIntegrationTest {
  ...
  public void searchQueryForSales() throws JsonProcessingException {
    ...
    TimestampField timestampField = new TimestampField("OrderDate", null,
  ...
  public void searchQueryForSalesWithTimeRelative() throws JsonProcessingException {
    ...
    TimeRelativeFilter relativeFilter = new TimeRelativeFilter("OrderDate", null, "year", null,
            TimeRelativeFilter.Tense.PREVIOUS.name(), 6, "Asia/Seoul", null);
  ...
  public void searchQueryForSalesWithExpression1() throws JsonProcessingException {
    ...
    List<UserDefinedField> userFields = Lists.newArrayList(
            ...
            new ExpressionField("switch_dim", "SWITCH( \"Category\", 'Furniture', 'F', 'Technology', 'T')", "dimension",
                    false),
            new ExpressionField("sumof_dim", "(SUMOF([SalesForecase]) - SUMOF( [Sales]  ) ) / SUMOF( [Sales]  ) * 100",
                    "measure", true)
  ...
  public void searchQueryForSalesWithTimestamp() throws JsonProcessingException {
    ...
    List<Filter> filters = Lists.newArrayList(
            //new IntervalFilter("OrderDate", "2011-01-04T00:00:00.000", "2012-05-19T00:00:00.000")
            new TimestampFilter("OrderDate", null, Lists.newArrayList("Dec 29, 2014", "Dec 30, 2014"),
                    new ContinuousTimeFormat(false, TimeFieldFormat.TimeUnit.DAY.name(), null)),
            new TimestampFilter("ShipDate", null, Lists.newArrayList("Sun", "Mon"),
                    new ContinuousTimeFormat(true, TimeFieldFormat.TimeUnit.DAY.name(),
                            TimeFieldFormat.ByTimeUnit.WEEK.name()))
    );

    // Case1
    Pivot pivot1 = new Pivot();
    TimestampField origianlTimeField1 = new TimestampField("OrderDate", null,
            new ContinuousTimeFormat(true, TimeFieldFormat.TimeUnit.MONTH.name(),
                    TimeFieldFormat.ByTimeUnit.YEAR.name()));
    ...
    TimestampField origianlTimeField3 = new TimestampField("OrderDate", null,
            new ContinuousTimeFormat(true, TimeFieldFormat.TimeUnit.HOUR.name(), null));
    ...
    TimestampField originalTimeField4 = new TimestampField("OrderDate", null,
            new ContinuousTimeFormat(false, TimeFieldFormat.TimeUnit.WEEK.name(), null));
    originalTimeField4.setAlias("WEEK(OrderDate)");

    DimensionField dimTimeField4 = new DimensionField("ShipDate", null,
            new ContinuousTimeFormat(true, TimeFieldFormat.TimeUnit.QUARTER.name(),
                    TimeFieldFormat.ByTimeUnit.YEAR.name()));
  ...
  public void searchQueryForSalesWithBarChart() throws JsonProcessingException {
    ...
    // Case 1. 디멘젼에 열선반에만 존재
    Pivot pivot1 = new Pivot();
    pivot1.setColumns(Lists.newArrayList(new DimensionField(
            "Category"))); //, new DimensionField("Sub-Category"))); //, new DimensionField("Sub-Category")));
    pivot1.setRows(Lists.newArrayList(new DimensionField("Sub-Category")));
    pivot1.setAggregations(Lists.newArrayList(
  ...
  public void searchQueryForEstateAbbrWithMapChart() throws JsonProcessingException {
    ...
    MapViewLayer layer1 = new MapViewLayer("layer1", "estate", fields,
            new LayerView.AbbreviatedView("h3", 12, RelayAggregation.RelayType.FIRST.name()));
    Shelf geoShelf = new GeoShelf(Arrays.asList(layer1));
  ...
  public void searchQueryForEstateWithMapChart() throws JsonProcessingException {
    ...
    List<Field> fields = Lists
            .newArrayList(new DimensionField("gis", null, null), new DimensionField("gu_new", "user_defined"),
                    new MeasureField("amt", null, MeasureField.AggregationType.NONE));
  ...
  public void searchQueryTimeFieldForSaleGeoWithMapChart() throws JsonProcessingException {
    ...
    List<Field> fields1 = Lists.newArrayList(new DimensionField("location", null, null),
            new MeasureField("Profit", null, MeasureField.AggregationType.AVG));
  ...
  public void searchQueryMultiLayerEstateSaleGeoWithMapChart() throws JsonProcessingException {
    ...
    List<Filter> filters = Lists.newArrayList(
            new SpatialBboxFilter("sales_geo", "location", null, "-123.52115624999999 23.439926562500006",
                    "-68.32584374999999 51.125473437500006", null),
            new SpatialBboxFilter("estate", "gis", null, "-123.52115624999999 23.439926562500006",
                    "-68.32584374999999 51.125473437500006", null)
    );

    List<Field> fields1 = Lists.newArrayList(new DimensionField("location", null, null), new DimensionField("City"),
            new MeasureField("Profit", null, MeasureField.AggregationType.AVG));
    MapViewLayer layer1 = new MapViewLayer("layer1", "sales_geo", fields1, new LayerView.ClusteringLayerView("h3", 5));

    List<Field> fields2 = Lists.newArrayList(new DimensionField("gis", null, null), new DimensionField("gu"),
            new MeasureField("amt", null, MeasureField.AggregationType.NONE));
  ...
  public void searchQueryDistanceWithinEstateRoadWithMapChart() throws JsonProcessingException {
    ...
    List<Field> fields1 = Lists
            .newArrayList(new DimensionField("gis"), new MeasureField("amt", null, MeasureField.AggregationType.NONE));
    ...
    GeoSpatialOperation operation = new GeoSpatialOperation.Within(1000, false,
            new GeoSpatialOperation.ChoroplethAggregation(MeasureField.AggregationType.AVG, "amt"));
  ...
  public void searchQueryDistanceWithinChoroplethEstateRoadWithMapChart() throws JsonProcessingException {
    ...
    GeoSpatialOperation operation = new GeoSpatialOperation.Within(1000, true,
            new GeoSpatialOperation.ChoroplethAggregation(MeasureField.AggregationType.SUM, "py"));
  ...
  public void searchQueryIntersectsEstateRoadWithMapChart() throws JsonProcessingException {
    ...
    List<Field> fields1 = Lists.newArrayList(new DimensionField("location", null, null), new DimensionField("City"),
            new MeasureField("Sales", null, MeasureField.AggregationType.NONE));
  ...
  public void searchQueryChoroplethSalesStateWithMapChart() throws JsonProcessingException {
    ...
    List<Field> fields1 = Lists.newArrayList(new DimensionField("location", null, null),
            new MeasureField("Sales", null, MeasureField.AggregationType.AVG));
    MapViewLayer layer1 = new MapViewLayer("layer1", "sales_geo", fields1, null);
  ...
  public void searchQueryEstateRoadWithMapChart() throws JsonProcessingException {
    ...
    List<Filter> filters = Lists.newArrayList(
            new SpatialBboxFilter("estate", "gis", null, "127.00702944992682 37.46699154436034",
                    "127.09886828659677 37.524326444262684", null),
            new SpatialBboxFilter("seoul_roads", "geom", null, "127.00702944992682 37.46699154436034",
                    "127.09886828659677 37.524326444262684", null)
    );
  ...
  public void searchQueryForSalesJoinedSelect() throws JsonProcessingException {
    ...
    JoinMapping joinMapping1 = new JoinMapping("sales_join_category", "join1", "LEFT_OUTER", keyPair1,
            childJoinMapping);
  ...
  public void groupbyQueryForUserDefined() throws JsonProcessingException {
    ...
    ExpressionField expressionField1 = new ExpressionField("ifcountd_case", "ifcountd(\"Region\"!='East', \"Region\")",
            "measure", true);
    ExpressionField expressionField2 = new ExpressionField("countd_case", "countd(\"Region\")", "measure", true);
    ExpressionField expressionField3 = new ExpressionField("avgof_case", "avgof(\"Sales\")", "measure", true);

    DimensionField dimField = new DimensionField("Segment");
    MeasureField mField1 = new MeasureField("ifcountd_case", "user_defined");
    MeasureField mField2 = new MeasureField("countd_case", "user_defined");
    MeasureField mField3 = new MeasureField("avgof_case", "user_defined");

    SearchQueryRequest request = new SearchQueryRequest();
    request.setDataSource(dataSource1);
    request.setFilters(filters);
    request.setProjections(Lists.newArrayList(dimField, mField1, mField2, mField3));
  ...
  public void checkSimilarity() {
    ...
    SimilarityQueryRequest queryRequest = new SimilarityQueryRequest(
            Lists.newArrayList("sales_geo", "sales_join_category"), null);
  ...
  public void getDataSourceFieldCovariance() throws JsonProcessingException {
    ...
    CovarianceQueryRequest covarianceRequest = new CovarianceQueryRequest(new DefaultDataSource("sales"),
            "DaystoShipScheduled", null, null);
  ...
  public void searchQuery_when_pivot_columns_order_by_desc() {
    ...
    assertThat(columns).extracting("name")
            .containsExactly("Standard Class―SUM(Sales)", "Second Class―SUM(Sales)", "Same Day―SUM(Sales)",
                    "First Class―SUM(Sales)");
  }
