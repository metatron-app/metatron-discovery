...
//    connection.setPassword("root");
  ...
  @Test
  public void searchPhoenixTables() {
    PhoenixConnection connection = new PhoenixConnection();
    connection.setHostname("localhost");
    connection.setPort(8765);
  ...
  @Test
  public void showTableInfoPhoenix() {
    PhoenixConnection connection = new PhoenixConnection();
    connection.setHostname("localhost");
    connection.setPort(8765);

    String schemaName = " ";
    String tableName = "DEFAULT_T1"; //METATRON1_T1, METATRON1_T2, METATRON1_T3, METATRON1_T4, METATRON1_TABLE1, METATRON1_TABLE2, METATRON1_TABLE3, METATRON1_TABLE4
  ...
  @Test
  public void showTableColumnPhoenix() {
    PhoenixConnection connection = new PhoenixConnection();
    connection.setHostname("localhost");
    connection.setPort(8765);

    String tableName = "sales";
    String schemaName = "METATRON_SCHEMA1";
  ...
  public void changeDatabase() {
    ...
    String database1 = "METATRON_SCHEMA1";
    String database2 = "METATRON_SCHEMA2";
