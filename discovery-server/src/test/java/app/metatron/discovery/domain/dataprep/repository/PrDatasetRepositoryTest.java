...
public class PrDatasetRepositoryTest extends AbstractIntegrationTest {
  ...
  public void crudTest() {
    ...
    System.out
            .println("UPDATE:: " + ToStringBuilder.reflectionToString(updatedDataset, ToStringStyle.MULTI_LINE_STYLE));
  ...
  public void deleteDataset() {
    ...
    if (dataset == null) {
      ...
      System.out.println(
              "DELETE:: failed - " + ToStringBuilder.reflectionToString(dataset, ToStringStyle.MULTI_LINE_STYLE));
    }
  }
