...
('HIVE', 'hive-local-enable-personal-database', 'polaris', now(), 'polaris', now(), 0, NULL, 'localhost', 'hive-local-enable-personal-database', NULL, 'hive', 10000, 'JDBC', NULL, 'hive', NULL, NULL, NULL, NULL, NULL, '{"metatron.hive.admin.name":"hive_admin","metatron.hive.admin.password":"1111","metatron.personal.database.prefix":"private","metatron.hdfs.conf.path":"/tmp/hdfs-conf"}');