...
export class DbConfigureSchemaComponent extends AbstractPopupComponent implements OnInit, OnDestroy {
  ...
  private initColumnData(databaseData: any) {
    const selectedType = databaseData.selectedType;
    const detailData = selectedType === 'TABLE' ? _.cloneDeep(databaseData.tableDetailData) : _.cloneDeep(databaseData.queryDetailData);
    this.fields = detailData.fields;
