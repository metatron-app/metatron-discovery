...
/**
 * Creating datasource with Stream - ingestion step
 */
@Component({
  selector: 'stream-ingestion',
  templateUrl: './stream-ingestion.component.html'
})
export class StreamIngestionComponent extends AbstractPopupComponent implements OnInit, OnDestroy, OnChanges {
  ...
  public onChangedPage(step: string): void {
    this._step = step === 'NEXT' ? 'stream-complete' : 'stream-configure-schema';
