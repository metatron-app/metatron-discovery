...
export class StagingDbConfigureSchemaComponent extends AbstractPopupComponent implements OnInit, OnDestroy {
  ...
  private isTimestampColumn(column): boolean {
    return this.selectedTimestampColumn && this.selectedTimestampColumn.name === column.name;
  }
   ...
   * @param databaseData
   */
  private initColumnData(databaseData: any) {
    this.fields = _.cloneDeep(databaseData.selectedTableDetail.fields);
    this.data = _.cloneDeep(databaseData.selectedTableDetail.data);
  }
