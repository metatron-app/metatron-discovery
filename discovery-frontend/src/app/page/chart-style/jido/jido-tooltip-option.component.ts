...
@Component({
  selector: 'jido-tooltip-option',
  templateUrl: './jido-tooltip-option.component.html'
})
export class JidoTooltipOptionComponent extends TooltipOptionComponent {
  ...
  @Input('uiOption')
  public set setUiOption(uiOption: UIJidoOption) {
